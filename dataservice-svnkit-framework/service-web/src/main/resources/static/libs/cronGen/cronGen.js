(function ($) {
    ...
    $.fn.extend({
        cronGen: function (options) {
            ...
            //create top menu
            var cronContainer = $("<div/>", { id: "CronContainer", style: "display:none;width:470px;height:340px;" });
            var mainDiv = $("<div/>", { id: "CronGenMainDiv", style: "width:470px;height:340px;" });
            var topMenu = $("<ul/>", { "class": "nav nav-tabs", id: "CronGenTabs" });
            $('<li/>', { 'class': 'active' }).html($('<a id="SecondlyTab" href="#Secondly">秒</a>')).appendTo(topMenu);
            $('<li/>').html($('<a id="MinutesTab" href="#Minutes">分</a>')).appendTo(topMenu);
            ...
            $(yearly2).append("周期从");
            $("<input/>",{type : "text", id : "yearStart_0", value : "1988", style:"width:45px; height:20px;"}).appendTo(yearly2);
            $(yearly2).append("-");
            $("<input/>",{type : "text", id : "yearEnd_0", value : "2018", style:"width:45px; height:20px;"}).appendTo(yearly2);
            $(yearly2).append("年");
            ...
            $b.popover({
                ...
                template: '<div class="popover" style="max-width:500px !important; width:470px;left:-341.656px;"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-title"></h3><div class="popover-content"><p></p></div></div></div>',
